...
**관리자가 카탈로그의 앱 템플릿, 앱 개발환경, 앱서비스 조회,등록,수정,삭제를 관리한다.<br>**
...
**관리자가 사용자의 정보를 조회 및 계정 승인을 관리한다.<br>**
...
**관리자가 PaaS-TA 포탈의 설정 정보를 조회,등록,수정한다.<br>**
...
**관리자가 PaaS-TA 포탈의 조직 및 공간 할당량을 조회,등록,수정,삭제를 관리한다.<br>**
...
**관리자가 서비스 브로커 URL를 등록하여 브로커 조회,등록,수정,삭제를 관리한다.<br>**
...
**관리자가 사용자에게 사용 할 수있는 서비스 계획을 제어하고 제한된 서비스 가용성을 관리한다.<br>**
...
**관리자가 staging, running 규칙을 사용하여 앱 및 작업 준비하고 특정 spaces에 대한 접근을 관리한다.**<br>
